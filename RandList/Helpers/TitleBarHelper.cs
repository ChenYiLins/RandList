...
internal class TitleBarHelper
{
    ...
    public static void UpdateTitleBar(ElementTheme theme)
    {
        ...
        else
        {
            ...
            {
                App.MainWindow.AppWindow.TitleBar.ForegroundColor = Colors.White;
                App.MainWindow.AppWindow.TitleBar.ButtonForegroundColor = Colors.White;
                App.MainWindow.AppWindow.TitleBar.ButtonHoverBackgroundColor = Color.FromArgb(30, 255, 255, 255);
                App.MainWindow.AppWindow.TitleBar.ButtonHoverForegroundColor = Colors.White;
                App.MainWindow.AppWindow.TitleBar.ButtonPressedBackgroundColor = Color.FromArgb(60, 255, 255, 255);
                App.MainWindow.AppWindow.TitleBar.ButtonPressedForegroundColor = Colors.White;
            }
            else
            {
                App.MainWindow.AppWindow.TitleBar.ForegroundColor = Colors.Black;
                App.MainWindow.AppWindow.TitleBar.ButtonForegroundColor = Colors.Black;
                App.MainWindow.AppWindow.TitleBar.ButtonHoverBackgroundColor = Color.FromArgb(30, 0, 0, 0);
                App.MainWindow.AppWindow.TitleBar.ButtonHoverForegroundColor = Colors.Black;
                App.MainWindow.AppWindow.TitleBar.ButtonPressedBackgroundColor = Color.FromArgb(60, 0, 0, 0);
                App.MainWindow.AppWindow.TitleBar.ButtonPressedForegroundColor = Colors.Black;
            }
        }
    }
